...
class MaskRCNN(object):
    ...
    def lr_scheduler(self, epoch):
        if(epoch > 0 and epoch % self.config.LR_STEPS == 0):
            self.lr = self.lr/10
        print("Learning Rate", self.lr) 
        #log("Learning Rate", self.lr)
        return self.lr
    ...
    def set_log_dir(self, model_path = None):
        ...
        self.model_name = 'mask_rcnn_model.{epoch:03d}-{loss:01f}.h5'
    ...
    def train(self, train_dataset, val_dataset, epochs,layers,models,
        ...
        # Data generators
        self.train_generator = DataGenerator(train_dataset, self.config, shuffle=True,
                                         augmentation=augmentation)
        self.val_generator = DataGenerator(val_dataset, self.config, shuffle=True)
